...
public class JanelaCompra extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Selecione Laborátorio:");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jCItemNovaCompra, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(90, 90, 90)))
                .addContainerGap())
        );
    ...
    private void jTTabelaMedMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jTTabelaMedMouseClicked
        ...
        if (user != null && "Administrador".equalsIgnoreCase(user.getFuncao())) {
            Object[] options = {"Ver Detalhes", "Cancelar Compra", "Voltar"};
            int escolha = JOptionPane.showOptionDialog(this,
                    "O que deseja fazer com a compra selecionada?",
                    "Opções da Compra",
            ...
            if (escolha == 0) { // Ver Detalhes
                JanelaDetalhesCompra detalhes = new JanelaDetalhesCompra(notaFiscal);
                detalhes.setVisible(true);
            } else if (escolha == 1) { // Cancelar Compra
                int confirm = JOptionPane.showConfirmDialog(this, 
                        "Tem certeza que deseja cancelar esta compra? O estoque será revertido.", 
            ...
            // Abre a janela de detalhes para outros usuários
            JanelaDetalhesCompra detalhes = new JanelaDetalhesCompra(notaFiscal);
            detalhes.setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaCompra.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
