...
public class JanelaDetalhesVenda extends javax.swing.JFrame {
    ...
    // Components
    private JTable jTTabelaItensVenda;
    ...
    private void carregarItensDaVenda() {
        ...
        modelo.setItensVenda(dao.readByNotaFiscal(notaFiscal));
    }
    ...
    private void buildUI() {
        ...
        jLabelTitulo = new JLabel("Detalhes da Venda");
        ...
        // ─── Table ───
        jTTabelaItensVenda = new JTable();
        styleTable(jTTabelaItensVenda);

        jScrollPane1 = new JScrollPane(jTTabelaItensVenda);
